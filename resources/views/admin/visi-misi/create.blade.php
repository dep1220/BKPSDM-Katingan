        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-semibold text-gray-900">Formulir Tambah Visi & Misi</h3>
                ...
                <form action="{{ route('admin.visi-misi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            name="visi"
                            rows="4"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('visi') @enderror"
                    ...
                    <div>
                        ...
                        <div id="misi-container">
                            @if(old('misi'))
                                @foreach(old('misi') as $index => $misi)
                                    <div class="misi-item mb-4 p-4 border border-gray-200 rounded-lg">
                                        ...
                                        <textarea
                                            name="misi[]"
                                            rows="3"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 @error('misi.*') @enderror"
                            ...
                            @else
                                <div class="misi-item mb-4 p-4 border border-gray-200 rounded-lg">
                                    <div class="flex justify-between items-start mb-2">
                                        <label class="text-sm font-medium text-gray-600">Misi 1</label>
                                    </div>
                                    <textarea
                                        name="misi[]"
                                        rows="3"
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Visi & Misi yang baru ditambahkan akan otomatis menjadi aktif dan menggantikan visi & misi yang sedang aktif sebelumnya.</p>
                                </div>
                            </div>
                        </div>
                    </div>
